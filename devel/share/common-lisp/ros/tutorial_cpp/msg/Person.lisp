...
(cl:in-package tutorial_cpp-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Person>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Person)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tutorial_cpp-msg:<Person> is deprecated: use tutorial_cpp-msg:Person instead.")))

(cl:ensure-generic-function 'first_name-val :lambda-list '(m))
(cl:defmethod first_name-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tutorial_cpp-msg:first_name-val is deprecated.  Use tutorial_cpp-msg:first_name instead.")
  (first_name m))

(cl:ensure-generic-function 'last_name-val :lambda-list '(m))
(cl:defmethod last_name-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tutorial_cpp-msg:last_name-val is deprecated.  Use tutorial_cpp-msg:last_name instead.")
  (last_name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tutorial_cpp-msg:age-val is deprecated.  Use tutorial_cpp-msg:age instead.")
  (age m))
